...
const db = new sqlite3.Database('montresmyDB.db');

// Lisez le fichier create_tables.sql et exécutez-le
const createTablesSQL = fs.readFileSync('create_mytables.sql', 'utf-8');
db.exec(createTablesSQL, (err) => {
  if (err) {
    ...
    const insertDataSQL = fs.readFileSync('insert_mydata.sql', 'utf-8');
